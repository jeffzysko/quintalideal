...
const faqs: FAQ[] = [
  ...
  { q: 'Como funciona a pontuação do quintal?', a: 'A pontuação é calculada pelo motor de recomendação V2 com base em 6 fatores: espaço disponível, tipo de moradia, uso pretendido, intenção de compra, preferência de modelo e orçamento. O sistema identifica o perfil do lead e recomenda o modelo mais adequado com um score de match.' },
  ...
  { q: 'O que é o Kanban no painel?', a: 'O Kanban é uma visualização em colunas do seu funil de vendas. No desktop, arraste os cards entre as colunas para mudar o status. No mobile, toque no card para acessar as opções. Ao mover para "Vendido", selecione o modelo vendido para alimentar as métricas de aderência. Você pode filtrar por temperatura, origem, cidade e período.' },
...
export default function Suporte() {
  ...
  return (
    <PageTransition>
    <div className="min-h-screen flex flex-col bg-background pb-[var(--bottom-nav-height)] md:pb-12">
      <PageHeader
        title="Suporte"
