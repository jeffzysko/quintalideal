...
const DB_ISSUES: DbIssue[] = [
  ...
  { file: 'FranchiseDashboard.tsx', line: '143', type: 'Over-fetching de colunas', severity: 'low', impact: 'Query de KPIs agora seleciona apenas 6 colunas (id, status_lead, created_at, updated_at, pontuacao_quintal, respostas_questionario). Query completa carrega sob demanda.', fix: 'Query separada para KPIs com colunas mínimas. Query completa só carrega quando tabs de Kanban/Reports/Achievements estão ativas.', done: true },
  { file: 'FranchiseDashboard.tsx', line: '162-177', type: 'Filtro no cliente ao invés do servidor', severity: 'medium', impact: 'lead_activities agora filtradas por .in("lead_id", leadIds) no servidor, com batching de 200 IDs por request.', fix: 'Filtro server-side implementado com batching para evitar limites de URL.', done: true },
...
const ACTION_ITEMS: ActionItem[] = [
  ...
  { id: 'a8', category: 'medium', title: 'Importar recharts seletivamente', impact: 'Sem impacto na v2', effort: 'N/A', description: 'Recharts v2 não suporta tree-shaking via caminhos profundos. Sem ação possível. Monitorar Recharts v3.', done: true, code: '// Recharts v2 não suporta ESM tree-shaking\n// Wrapper centralizado em chart.tsx já limita imports\n// Aguardar Recharts v3 para suporte nativo' },
  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-background pb-[var(--bottom-nav-height)] md:pb-12">
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6 py-4 sm:py-6 space-y-6">
