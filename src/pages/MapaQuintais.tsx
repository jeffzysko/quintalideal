      ...
      <div className="px-4 md:px-6 py-4 md:py-6 max-w-5xl mx-auto">
        ...
        {loading ? (
          ...
          <>
            ...
            >
              <Card className="card-premium mb-6 overflow-hidden border-border/40">
                ...
                <CardContent>
                  <div
                    className="relative w-full aspect-[4/3] rounded-xl overflow-hidden border border-border/30"
                  ...
                  >
                    ...
                    {cityData.map(city => {
                      ...
                      const isHot = city.count / maxCount > 0.5;
                      ...
                      return (
                        <Tooltip key={city.cidade}>
                            ...
                            >
                              ...
                              {isHot && (
                                <motion.div
                                  ...
                                  style={{ backgroundColor: color, inset: '-25%' }}
                          ...
                          <TooltipContent side="top" className="text-xs backdrop-blur-lg bg-card/95 border-border/50">
            ...
            >
              ...
              <p className="text-[10px] text-muted-foreground/50">
                Mapa de Calor Splash RS © {new Date().getFullYear()}
              </p>
            </motion.div>
          </>
        )}
