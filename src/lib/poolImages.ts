...
const retangularSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 250">
...
const bordaInfinitaSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 250">
  <rect width="400" height="250" fill="${BG}" rx="16"/>
...
const prainhaSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 250">
  <rect width="400" height="250" fill="${BG}" rx="16"/>
...
const eleganceSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 250">
  <rect width="400" height="250" fill="${BG}" rx="16"/>
...
const retangularPlusSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 250">
  <rect width="400" height="250" fill="${BG}" rx="16"/>
...
const supremeSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 250">
  <rect width="400" height="250" fill="${BG}" rx="16"/>
...
const versatilSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 250">
  <rect width="400" height="250" fill="${BG}" rx="16"/>
...
const confortSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 250">
  <rect width="400" height="250" fill="${BG}" rx="16"/>
...
const familySvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 250">
  <rect width="400" height="250" fill="${BG}" rx="16"/>
...
const compactaPremiumSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 250">
  <rect width="400" height="250" fill="${BG}" rx="16"/>
